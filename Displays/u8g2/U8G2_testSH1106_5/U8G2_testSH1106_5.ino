...
void loop() {
  ...
  u8g2.drawXBMP(16, 16, image_01411_width, image_01411_height, image_01411_bits);
  u8g2.sendBuffer();
  delay(50);
  u8g2.clearBuffer();
  u8g2.setCursor(0, 0);
  u8g2.print(millis(), DEC);
  u8g2.drawXBMP(16, 16, image_01412_width, image_01412_height, image_01412_bits);
  u8g2.sendBuffer();
  delay(50);
  u8g2.clearBuffer();
  u8g2.setCursor(0, 0);
  u8g2.print(millis(), DEC);
  u8g2.drawXBMP(16, 16, image_01413_width, image_01413_height, image_01413_bits);
  u8g2.sendBuffer();
  delay(50);
  u8g2.clearBuffer();
  u8g2.setCursor(0, 0);
  u8g2.print(millis(), DEC);
  u8g2.drawXBMP(16, 16, image_01414_width, image_01414_height, image_01414_bits);
  u8g2.sendBuffer();
  delay(50);
  u8g2.clearBuffer();
  u8g2.setCursor(0, 0);
  u8g2.print(millis(), DEC);
  u8g2.drawXBMP(16, 16, image_01415_width, image_01415_height, image_01415_bits);
  u8g2.sendBuffer();
  delay(50);
  u8g2.clearBuffer();
  u8g2.setCursor(0, 0);
  u8g2.print(millis(), DEC);
  u8g2.drawXBMP(16, 16, image_01416_width, image_01416_height, image_01416_bits);
  u8g2.sendBuffer();
  delay(50);
}
