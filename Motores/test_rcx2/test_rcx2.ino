...
//pines Canales 1 y 2 del receptor RC
#define canal1 10
#define canal2 11
...
long tmpA = 0, tmpB = 0;
int motI = 0, motD = 0;
unsigned long pulsoA = 0, pulsoB = 0;
...
void loop() {
  ...
  if (pulsoA != 0 && pulsoB != 0) //solo entra si sigue recibiendo señal
  {
    ...
    //En mi caso, ni siquiera tiene que llegar al 100% de PWM
    //porque los motores son de 3V y alimento el circuito a 7.2V
    tmpA = tmpA * 0.3;
    tmpB = tmpB * 0.3;
