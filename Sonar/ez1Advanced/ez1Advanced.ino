...
Maxbotix rangeSensorPW(9, Maxbotix::PW, Maxbotix::LV, Maxbotix::BEST);
//Maxbotix rangeSensorTX(6, Maxbotix::TX, Maxbotix::LV, Maxbotix::MEDIAN);
Maxbotix rangeSensorAD(A1, Maxbotix::AN, Maxbotix::LV, Maxbotix::BEST, 9);
...
void loop()
{
	...
	Serial.println(rangeSensorPW.getSampleMode(true));
	Serial.print(" - Lowest Mode: ");
	Serial.println(rangeSensorPW.getSampleMode(false));
	Serial.print(" - Median: ");
	Serial.println(rangeSensorPW.getSampleMedian());
	Serial.print(" - Best: ");
	Serial.println(rangeSensorPW.getSampleBest());
	Serial.println();
...
*/
	...
	Serial.println();
	Serial.print(" - Highest Mode: ");
	Serial.println(rangeSensorAD.getSampleMode(true));
	Serial.print(" - Lowest Mode: ");
	Serial.println(rangeSensorAD.getSampleMode(false));
	Serial.print(" - Median: ");
	Serial.println(rangeSensorAD.getSampleMedian());
	Serial.print(" - Best: ");
